...
namespace server.src.Domain.Weather.Collections.Forecasts.Models;
...
public class Forecast : BaseEntity
{
    ...
    /// This represents the foreign key linking to the station entity.
    /// </summary>
    ...
    /// This links the forecast to the corresponding station.
    /// </summary>
