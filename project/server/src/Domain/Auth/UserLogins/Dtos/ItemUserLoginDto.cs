namespace server.src.Domain.Auth.UserLogins.Dtos;

/// <summary>
/// Represents a user's login details with an external authentication provider.
/// </summary>
...
public record ItemUserLoginDto(
    Guid Id,
