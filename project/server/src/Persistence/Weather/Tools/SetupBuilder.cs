...
using server.src.Persistence.Weather.Tools.Series;
...
public static class SetupBuilder
{
    ...
    public static void SetupTools(this ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfiguration(new SerieConfiguration("Series", _toolsSchema));
        ...
        modelBuilder.ApplyConfiguration(new SerieIndexes());
