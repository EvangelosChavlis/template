...
using server.src.Application.Geography.Natural.Timezones.Services;
using server.src.Application.Common.Interfaces;
using server.src.Application.Common.Services;

namespace server.src.Application.Geography.Natural.Timezones;
...
public static class DI
{
    ...
    {       
        ...
        // Register TimezoneCommands and TimezoneQueries
        services.AddTransient<ITimezoneCommands, TimezoneCommands>();
        services.AddTransient<ITimezoneQueries, TimezoneQueries>();
