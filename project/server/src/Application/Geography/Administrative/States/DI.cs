...
using server.src.Application.Geography.Administrative.States.Services;
using server.src.Application.Common.Interfaces;
using server.src.Application.Common.Services;

namespace server.src.Application.Geography.Administrative.States;

public static class DI
{
    public static IServiceCollection RegisterStates(this IServiceCollection services)
    {       
        ...
        // Register StateCommands and StateQueries
        services.AddTransient<IStateCommands, StateCommands>();
