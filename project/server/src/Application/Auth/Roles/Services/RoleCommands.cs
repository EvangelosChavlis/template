...
public class RoleCommands : IRoleCommands
{
        ...
        CancellationToken token = default)
    {
        ...
        return await _requestExecutor.Execute<InitializeRolesCommand, Response<string>>(command, token);
    }
        ...
        CancellationToken token = default)
    {
        ...
        return await _requestExecutor.Execute<CreateRoleCommand, Response<string>>(command, token);
    }
    ...
    public async Task<Response<string>> UpdateRoleAsync(Guid id, UpdateRoleDto dto, CancellationToken token = default)
    {
        ...
        return await _requestExecutor.Execute<UpdateRoleCommand, Response<string>>(command, token);
    }
    ...
    public async Task<Response<string>> ActivateRoleAsync(Guid id, Guid version, CancellationToken token = default)
    {
        ...
        return await _requestExecutor.Execute<ActivateRoleCommand, Response<string>>(command, token);
    }
        ...
        Guid version, CancellationToken token = default)
    {
        ...
        return await _requestExecutor.Execute<DeactivateRoleCommand, Response<string>>(command, token);
    }
        ...
        Guid version, CancellationToken token = default)
    {
        ...
        return await _requestExecutor.Execute<DeleteRoleCommand, Response<string>>(command, token);
    }
}
