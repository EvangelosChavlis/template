...
public static class UserValidators
{
    public static ValidationResult Validate(CreateUserDto dto)
    {
        ...
        else if (ContainsInjectionCharacters(dto.FirstName) || ContainsNonPrintableCharacters(dto.FirstName))
        ...
        else if (ContainsInjectionCharacters(dto.LastName) || ContainsNonPrintableCharacters(dto.LastName))
